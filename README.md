...
AVSHack is a Linux live streaming server that supports Ingesting, Mixing, MultiMux, and Multistreaming of RTMP, RTSP, SRT, and MP4 with LL-HLS and WebTransport Viewing.
